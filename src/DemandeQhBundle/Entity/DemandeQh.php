...
class DemandeQh
{
     ...
     * @var string
     *
     * @ORM\Column(name="siAncienDemande", type="string", nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="typeMotif", type="string", length=100,nullable=true )
     */
    private $typeMotif;
     ...
     * @var string
     *
     * @ORM\Column(name="prefixe", type="text", nullable=true)
     */
    private $prefixe;
    /**
     * @var string
     ...
     * @var string
     *
     * @ORM\Column(name="dateConfirme", type="datetime", nullable=true)
     */
    private $dateConfirme;

    //    ---------------RELATION---------------

    /**
     * @ORM\OneToOne(targetEntity="DemandeQhBundle\Entity\Etat")
...
//    ---------------//////RELATION//////---------------
     ...
     * Set dossier
     *
     * @param \DemandeQhBundle\Entity\Dossier $dossier
     *
     * @return DemandeQh
     */
    public function setDossier(\DemandeQhBundle\Entity\Dossier $dossier = null)
    {
